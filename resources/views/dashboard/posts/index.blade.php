...
<button type="button" class="btn btn-warning btn-sm float-right" data-toggle="modal"  data-target="#createNew">
 Create New
</button>
<br>
                         ...
                         <table id="filter" class="table table-striped" width="20%">
                             <thead class="table table-bordered">
                                 <tr>
                                     ...
                                     <th class="text-center" rowspan="1">Data 1</th>
                                     <th class="text-center" rowspan="1">Data 2</th>
                                     <th class="text-center" rowspan="1">Data 3</th>
